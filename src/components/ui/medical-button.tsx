  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        medical: "bg-gradient-medical text-white hover:shadow-medical transform hover:scale-105 transition-all duration-200",
        hero: "bg-gradient-hero text-white px-8 py-4 text-lg font-semibold hover:shadow-floating transform hover:scale-105 transition-all duration-300",
        symptom: "bg-medical-blue-light text-primary border-2 border-primary/20 hover:bg-primary hover:text-white transition-all duration-200",
